...
- **Auth**: Egen användarhantering med användarnamn + lösenord
  ...
  vid första login. Roller: `reader` (anställda musiker/körledare som
  inte är fullt betrodda redigerare), `editor` (betrodda redigerare),
  `admin` (bibliotekarier). Fullständig permissions-matris i
  `docs/permissions.md` - uppdatera den vid rollpolicy-ändringar.
